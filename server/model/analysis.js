...
const issueSchema = new mongoose.Schema({
    ...
    reccommendation: {type: String, required: true},
}, {_id: false})
...
const analysisSchema = new mongoose.Schema({
    ...
    links: {
        internal: {type: Number, defailt: 0},
        external: {type: Number, defailt: 0},
        broken: {type: Number, defailt: 0},
        total: {type: Number, defailt: 0},
    },
    images: {
        total: {type: Number, defailt: 0},
        missingAlt: {type: Number, defailt: 0},
        withAlt: {type: Number, defailt: 0},
    },
    keywords: [
        {
            word: String,
